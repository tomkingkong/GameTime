...
canvas.addEventListener('click', function (event) {
  ...
  var counterMissile = new Weapon(300, 520, 10, 10, 'rgb(0, 200, 200)', 0, 0, 0, {x:300, y:520}, {x:event.layerX, y:event.layerY}, 5, true)
...
function explosion(explosion) {
  var explosion = new Target(explosion.x, explosion.y, 50, 50, explosion.color, 0, 0, 0, true);
